"""Delete default create and update column
...
revision: str = '04357ff5f6d1'
down_revision: Union[str, None] = '72c4d27522c6'
...
def downgrade() -> None:
    ...
    op.add_column('tweets', sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    # ### end Alembic commands ###
